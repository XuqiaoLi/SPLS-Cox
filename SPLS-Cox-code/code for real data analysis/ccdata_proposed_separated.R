  ...
  while(count<1){
    ...
    if(criterion<=crit) { 
      ...
      return(list(beta=beta,gamma=gamma,alpha=alpha,inv_hessianbt=invHB,varbeta=varbeta,
                  ...
                  linkxbeta=linkxbeta,linkres=linkres,corindex=corindex,rn1=Rnindex1,rn2=Rnindex2))
    }
  }
}


replicate_time=27000
...
sfStop()
save(res,file=paste('realdata_varbeta_separated',Rnindex,'CCfpca','.Rdata',sep = ''))
